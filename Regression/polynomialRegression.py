...
# Squared Length Data for Polynomial Regression
...
# Print predict value of 50cm perch
print("\n---------------------- prediction of 50cm perch using polynomial Regression ----------------------")
print(lr_model.predict([[50**2,50]]))
...
# Draw a straight line by section
point = np.arange(15,50)

# Draw training set scatterplot
plt.scatter(X_train, y_train)

# 15~49 Draw a quadratic equation graph
plt.plot(point, 1.01*point**2 - 21.6*point + 116.05)

# get the 50cm perch data
...
print(round(float(lr_model.score(X_train_poly,y_train)),2))
print("\n---------------------- Score of linear Regression model ( test set )  ----------------------")
print(round(float(lr_model.score(X_test_poly,y_test)),2))
